...
- **Programming**: Python, JavaScript, C++, TypeScript, Java
...
- **DevOps**: Docker, Kubernetes, Jenkins, GitLab CI/CD, Jira
- **MLOps**: MLflow, Airflow, TensorBoard, ETL, DataWareHouse, Domo
